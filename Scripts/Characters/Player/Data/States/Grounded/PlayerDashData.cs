...
namespace MovementSystem
{
    ...
    public class PlayerDashData
    {
        ...
        [field: SerializeField] [field: Range(0f, 1f)] public float DashAfterRollingCooldown { get; private set; } = 0.75f;
        [field: SerializeField] [field: Range(0f, 1f)] public float DashHardLandingCooldown { get; private set; } = 1f;
    }
}